...
module.exports.getLanguages = (array) => {
    const result = array.map(index => list.langs[index - 1]);
    return result
}

module.exports.getRegions = (array) => {
    const result = array.map(index => list.regions[index - 1]);
    return result
}

module.exports.getGuideCategories = (element) => {
    let result
    switch (element) {
        case "0": {
            result = 'Toifasiz'
...
module.exports.getGuideTypes = (element) => {
    let result
    switch (element) {
        case "interpreter": {
            result = 'Gid-tarjimon'
        ...
        case "excursion_guide": {
            result = 'Ekskursiya yetakchisi'
            break;
        }
        case "mountain_guide": {
            result = 'Yo‘riqchi-yo‘l boshlovchi'
            break;
        }
    }
    return result
